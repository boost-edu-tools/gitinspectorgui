    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-2">
          ...
          />
          <label htmlFor="scaled_percentages" className="text-sm text-foreground">
            Scaled Percentages
          </label>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="rounded border-input"
          />
          <label htmlFor="blame_exclusions" className="text-sm text-foreground">
            Blame Exclusions
          </label>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="rounded border-input"
          />
          <label htmlFor="dynamic_blame_history" className="text-sm text-foreground">
